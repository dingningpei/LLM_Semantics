...
\title{Semantic Generation for Graph Reasoning In Large Language Model}
...
\section{Methodology}
\subsection{Semantic Modeling for Structure Data}
\paragraph{Problem Formulation} Suppose we have a database, with different data type such as XML, Json and Tabular, denoted as D. We have a set of Ontologies \Omega.  
