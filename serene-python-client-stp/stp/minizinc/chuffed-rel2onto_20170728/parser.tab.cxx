...
static const yytype_uint16 yyrline[] =
{
     ...
     542,   545,   546,   553,   583,   612,   617,   646,   670,   679,
     691,   751,   803,   810,   865,   878,   891,   898,   912,   916,
     931,   955,   956,   960,   962,   965,   965,   967,   971,   973,
     988,  1012,  1013,  1017,  1019,  1023,  1027,  1029,  1044,  1068,
    1069,  1073,  1075,  1078,  1081,  1083,  1098,  1122,  1123,  1127,
    1129,  1132,  1137,  1138,  1143,  1144,  1149,  1150,  1155,  1156,
    1160,  1178,  1199,  1221,  1229,  1246,  1248,  1250,  1256,  1258,
    1271,  1272,  1279,  1281,  1288,  1289,  1293,  1295,  1300,  1301,
    1305,  1307,  1312,  1313,  1317,  1319,  1324,  1325,  1329,  1331,
    1339,  1341,  1345,  1347,  1352,  1353,  1357,  1359,  1361,  1363,
    1365,  1414,  1428,  1429,  1433,  1435,  1443,  1454,  1476,  1477,
    1485,  1486,  1490,  1492,  1496,  1500,  1504,  1506,  1510,  1512,
    1516,  1518,  1520,  1522,  1524,  1567
};
#endif
        ...
        if ((yyvsp[(6) - (6)].oArg)()) {
          ...
          if (arg->isInt()) {
            pp->intvars.push_back(varspec((yyvsp[(4) - (6)].sValue),
              new IntVarSpec(arg->getInt(),!print,(yyvsp[(5) - (6)].argVec),std::string((yyvsp[(4) - (6)].sValue)))));
          } else if (arg->isIntVar()) {
            pp->intvars.push_back(varspec((yyvsp[(4) - (6)].sValue),
              new IntVarSpec(Alias(arg->getIntVar()),!print,(yyvsp[(5) - (6)].argVec),std::string((yyvsp[(4) - (6)].sValue)))));
          } else {
          ...
          pp->intvars.push_back(varspec((yyvsp[(4) - (6)].sValue), new IntVarSpec((yyvsp[(2) - (6)].oSet),!print,(yyvsp[(5) - (6)].argVec),std::string((yyvsp[(4) - (6)].sValue)))));
        }
        //delete $5; 
        ...
        if ((yyvsp[(6) - (6)].oArg)()) {
          ...
          if (arg->isBool()) {
            pp->boolvars.push_back(varspec((yyvsp[(4) - (6)].sValue),
              new BoolVarSpec(arg->getBool(),!print,(yyvsp[(5) - (6)].argVec),std::string((yyvsp[(4) - (6)].sValue)))));            
          } else if (arg->isBoolVar()) {
            pp->boolvars.push_back(varspec((yyvsp[(4) - (6)].sValue),
              new BoolVarSpec(Alias(arg->getBoolVar()),!print,(yyvsp[(5) - (6)].argVec),std::string((yyvsp[(4) - (6)].sValue)))));
          } else {
          ...
          pp->boolvars.push_back(varspec((yyvsp[(4) - (6)].sValue), new BoolVarSpec((yyvsp[(2) - (6)].oSet),!print,(yyvsp[(5) - (6)].argVec),std::string((yyvsp[(4) - (6)].sValue)))));
        }
        //delete $5; 
        free((yyvsp[(4) - (6)].sValue));
      }
...
#line 932 "flatzinc/parser.yxx"
  ...
  case 51:
/* Line 1787 of yacc.c  */
#line 955 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = new vector<VarSpec*>(0); }
    break;

  case 52:
/* Line 1787 of yacc.c  */
#line 957 "flatzinc/parser.yxx"
...
#line 989 "flatzinc/parser.yxx"
  ...
  case 61:
/* Line 1787 of yacc.c  */
#line 1012 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = new vector<VarSpec*>(0); }
    break;

  case 62:
/* Line 1787 of yacc.c  */
#line 1014 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = (yyvsp[(1) - (2)].varSpecVec); }
    break;
...
#line 1045 "flatzinc/parser.yxx"
  ...
  case 69:
/* Line 1787 of yacc.c  */
#line 1068 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = new vector<VarSpec*>(0); }
    break;

  case 70:
/* Line 1787 of yacc.c  */
#line 1070 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = (yyvsp[(1) - (2)].varSpecVec); }
    break;
...
#line 1099 "flatzinc/parser.yxx"
  ...
  case 77:
/* Line 1787 of yacc.c  */
#line 1122 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = new vector<VarSpec*>(0); }
    break;

  case 78:
/* Line 1787 of yacc.c  */
#line 1124 "flatzinc/parser.yxx"
    { (yyval.varSpecVec) = (yyvsp[(1) - (2)].varSpecVec); }
    break;
...
#line 1251 "flatzinc/parser.yxx"
  ...
  case 98:
/* Line 1787 of yacc.c  */
#line 1257 "flatzinc/parser.yxx"
    { (yyval.oSet) = Option<AST::SetLit* >::none(); }
    break;

  case 99:
/* Line 1787 of yacc.c  */
#line 1259 "flatzinc/parser.yxx"
    { bool haveTrue = false;
...
#line 1428 "flatzinc/parser.yxx"
  ...
  case 133:
/* Line 1787 of yacc.c  */
#line 1430 "flatzinc/parser.yxx"
    { (yyval.argVec) = (yyvsp[(1) - (2)].argVec); }
    break;

  case 134:
/* Line 1787 of yacc.c  */
#line 1434 "flatzinc/parser.yxx"
    { (yyval.argVec) = new AST::Array((yyvsp[(1) - (1)].arg)); }
    break;

  case 135:
/* Line 1787 of yacc.c  */
#line 1436 "flatzinc/parser.yxx"
    { (yyval.argVec) = (yyvsp[(1) - (3)].argVec); (yyval.argVec)->append((yyvsp[(3) - (3)].arg)); }
    break;

  case 136:
/* Line 1787 of yacc.c  */
#line 1444 "flatzinc/parser.yxx"
    { 
        ParserState *pp = static_cast<ParserState*>(parm);
...
#line 1455 "flatzinc/parser.yxx"
  ...
  case 140:
/* Line 1787 of yacc.c  */
#line 1485 "flatzinc/parser.yxx"
    { (yyval.argVec) = NULL; }
    break;

  case 141:
/* Line 1787 of yacc.c  */
#line 1487 "flatzinc/parser.yxx"
    { (yyval.argVec) = (yyvsp[(1) - (1)].argVec); }
    break;

  case 142:
/* Line 1787 of yacc.c  */
#line 1491 "flatzinc/parser.yxx"
    { (yyval.argVec) = new AST::Array((yyvsp[(2) - (2)].arg)); }
    break;

  case 143:
/* Line 1787 of yacc.c  */
#line 1493 "flatzinc/parser.yxx"
    { (yyval.argVec) = (yyvsp[(1) - (3)].argVec); (yyval.argVec)->append((yyvsp[(3) - (3)].arg)); }
    break;

  case 144:
/* Line 1787 of yacc.c  */
#line 1497 "flatzinc/parser.yxx"
    { 
  ...
  case 145:
/* Line 1787 of yacc.c  */
#line 1501 "flatzinc/parser.yxx"
    { (yyval.arg) = (yyvsp[(1) - (1)].arg); }
    break;

  case 146:
/* Line 1787 of yacc.c  */
#line 1505 "flatzinc/parser.yxx"
    { (yyval.arg) = new AST::Array((yyvsp[(1) - (1)].arg)); }
    break;

  case 147:
/* Line 1787 of yacc.c  */
#line 1507 "flatzinc/parser.yxx"
    { (yyval.arg) = (yyvsp[(1) - (3)].arg); (yyval.arg)->append((yyvsp[(3) - (3)].arg)); }
    break;

  case 148:
/* Line 1787 of yacc.c  */
#line 1511 "flatzinc/parser.yxx"
    { (yyval.arg) = (yyvsp[(1) - (1)].arg); }
    break;

  case 149:
/* Line 1787 of yacc.c  */
#line 1513 "flatzinc/parser.yxx"
    { (yyval.arg) = (yyvsp[(2) - (3)].arg); }
    break;

  case 150:
/* Line 1787 of yacc.c  */
#line 1517 "flatzinc/parser.yxx"
    { (yyval.arg) = new AST::BoolLit((yyvsp[(1) - (1)].iValue)); }
    break;

  case 151:
/* Line 1787 of yacc.c  */
#line 1519 "flatzinc/parser.yxx"
    { (yyval.arg) = new AST::IntLit((yyvsp[(1) - (1)].iValue)); }
    break;

  case 152:
/* Line 1787 of yacc.c  */
#line 1521 "flatzinc/parser.yxx"
    { (yyval.arg) = new AST::FloatLit((yyvsp[(1) - (1)].dValue)); }
    break;

  case 153:
/* Line 1787 of yacc.c  */
#line 1523 "flatzinc/parser.yxx"
    { (yyval.arg) = (yyvsp[(1) - (1)].setLit); }
    break;

  case 154:
/* Line 1787 of yacc.c  */
#line 1525 "flatzinc/parser.yxx"
    { 
        vector<int> as;
        ParserState* pp = static_cast<ParserState*>(parm);
        if (pp->intvararrays.get((yyvsp[(1) - (1)].sValue), as)) {
